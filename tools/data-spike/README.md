...
The `site` command contacts live providers: USGS, Meta/WRI on AWS, ESA WorldCover on AWS, the USFS BIGMAP service and LANDFIRE. `--record <dir>` re-captures the S1M test fixture.
