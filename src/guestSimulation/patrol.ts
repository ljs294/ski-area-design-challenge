...
import { assertPatrolSimulationOptions } from './patrolValidation.ts';
export { assertPatrolSimulationOptions } from './patrolValidation.ts';
...
export class PatrolSimulation {
  ...
  snapshot(): PatrolSnapshot {
    ...
    const projection: Omit<PatrolSnapshot, 'checksum'> = {
      ...
      // Snapshot revisions count authoritative patrol events, not transport
      // commands. This keeps checksums invariant to advance chunking.
