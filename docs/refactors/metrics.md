...
## Change from the A2 formal baseline through R2

| Metric | Net change |
| --- | ---: |
| Production physical lines | -473 (-1.6%) |
| Test physical lines | +3,199 (+40.1%) |
| MapView physical lines | +8 (+0.2%) |
...
| Desktop production artifact bytes | -65,215,482 (-89.1%) |
